...
then
	echo "build for mac"
	TARGET_PATH=/home/user1/workspaces/libs/release/mac
elif [ $BUILD_TYPE = "BUILD_IOS_LIB" ]
then
	echo "build for ios"
	TARGET_PATH=/home/user1/workspaces/libs/release/ios/ios15
elif [ $BUILD_TYPE = "BUILD_IOSSIM_LIB" ]
then
       	echo "build for iossim"
       	TARGET_PATH=/home/user1/workspaces/libs/release/iossim/sim15 
elif [ $BUILD_TYPE = "BUILD_ANDROID_LIB" ]
then 
	echo "build for android"
	TARGET_PATH=/home/user1/workspaces/libs/release/android/r21
else
	echo "unknow build type: BUILD_MAC_LIB/BUILD_IOS_LIB/BUILD_IOSSIM_LIB/BUILD_ANDROID_LIB"
	exit 1
fi
