...
./configure \
	...
	CFLAGS="${CFLAGS} -fPIC -std=c++11 -stdlib=libc++ -fvisibility=hidden -fvisibility-inlines-hidden -g -isysroot /home/user1/tools/toolchains/mac/macos12/SDK/MacOSX12.3.sdk" 
