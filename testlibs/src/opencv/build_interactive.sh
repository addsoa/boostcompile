...
./calibController.cpp ./calibPipeline.cpp ./frameProcessor.cpp ./parametersController.cpp ./rotationConverters.cpp ./interactive_main.cpp \
-o ./opencv_sample \
 ...
 $OPCV_LIB_PATH/libopencv_features2d.a \
